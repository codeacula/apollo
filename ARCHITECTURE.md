...
- **Event Sourcing**: The way the user will interact with the system lends itself to using Event Sourcingb as the source-of-truth. We accomplish this using **PostGres** with **Marten**.
