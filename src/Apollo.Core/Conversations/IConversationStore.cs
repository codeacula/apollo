...
public interface IConversationStore
{
  ...
  Task<Result<Conversation>> CreateAsync(PersonId id, Content message, CancellationToken cancellationToken = default);
  ...
  Task<Result<Conversation>> GetOrCreateConversationByPersonIdAsync(PersonId personId, Content initialMessage, CancellationToken cancellationToken = default);
}
