...
public interface IApolloAIAgent
{
  ...
  Task<TwoPhaseCompletionResultDTO> TwoPhaseCompletionAsync(TwoPhaseCompletionRequestDTO request, double toolCallingTemperature, double responseTemperature, CancellationToken cancellationToken = default);
