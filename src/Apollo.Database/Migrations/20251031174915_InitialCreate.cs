...
namespace Apollo.Database.Migrations
{
  ...
  public partial class InitialCreate : Migration
  {
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ...
            ChatText = table.Column<string>(type: "text", nullable: false),
            Outgoing = table.Column<bool>(type: "boolean", nullable: false),
            CreatedWhen = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
          },
          constraints: table =>
          {
      ...
      // Create Quartz Scheduler tables from SQL file
      migrationBuilder.CreateTable(
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.DropTable("qrtz_blob_triggers");
      migrationBuilder.DropTable("qrtz_calendars");
      migrationBuilder.DropTable("qrtz_cron_triggers");
      migrationBuilder.DropTable("qrtz_fired_triggers");
      migrationBuilder.DropTable("qrtz_locks");
      migrationBuilder.DropTable("qrtz_paused_trigger_grps");
      migrationBuilder.DropTable("qrtz_scheduler_state");
      migrationBuilder.DropTable("qrtz_simprop_triggers");
      migrationBuilder.DropTable("qrtz_simple_triggers");
      migrationBuilder.DropTable("qrtz_triggers");
      migrationBuilder.DropTable("qrtz_job_details");
    }
  }
}
