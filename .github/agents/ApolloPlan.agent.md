...
Use tool:mcp_docker/sequentialthinking to analyze the task and generate insights. Use tool:ms-vscode.vscode-websearchforcopilot/websearch to gather additional information from the web. When considering adding a Nuget package, use tool:ms-vscode.vscode-websearchforcopilot/websearch to make sure you select the most recent version, or a previous one only if appropriate.
